...
class ParamTypeMissingError extends Error {
    constructor(object, propertyName, index) {
        super(`Cannot get reflected type for a "${propertyName}" method's ${index + 1}. parameter of ${object.constructor.name} class. ` +
